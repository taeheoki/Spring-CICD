package com.example.cicd.core.advice;
...
public class MyLogAdvice {
    ...
    @Pointcut("@annotation(com.example.cicd.core.annotation.MyLog)")
    public void myLog(){}

    @Pointcut("@annotation(com.example.cicd.core.annotation.MyErrorLog)")
